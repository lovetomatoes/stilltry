...
The average duty cycle in super-Eddington phases is $\simeq 15\%$ for massive BHs that reach $\gtrsim 10^8~\Msun$ by $z\simeq 6$,
which is nearly twice that of the entire population.
We also find that the observed Eddington-ratio distribution function is skewed to a log-normal shape 
