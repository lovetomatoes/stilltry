...
\tablewidth{0pt}
\tablecaption{Parametric Quasar Luminosity Function}
\tablehead{
...
\enddata
\label{tab:QLF_fit}
\tablecomments{Parametric fitting function of both unobscured and intrinsic QLFs at $z=6-10$, produced by the best-fit model with $\fseed=0.01$.
}
\end{deluxetable*}
