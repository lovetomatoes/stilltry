...
However, understanding the accretion and radiation properties of growing BHs in the high-$z$ environments 
still remains challenging.
In this work, based on a semi-analytic BH seed formation model, 
we relate BH seeds with the growth tracks of their parent halos. 
We then construct a model of BH mass and luminosity evolution 
characterizing the episodical BH accretion and Eddington ratio distribution function (ERDF).
The model parameters are fitted to reproduce the observed BHMF and QLF of the quasar population at $z\sim$ 6.
...
The duty cycle of active accretion is $f_{\rm duty}\sim 0.15$ for massive BHs with $M\gtrsim 10^8~\Msun$, 
...
We predict the early evolution of BHMF and QLF, as well as the growth patterns of individual BHs, 
which will likely be unveiled by the James Webb Space Telescope (JWST) and future deep and wide-field surveys.
%  with, e.g. 
...
\blue{
Nevertheless, starting from empirical BH seeding, combinded with growth chanels e.g., merger and accretion modes,
models can in return give prediction of the QLF at high redshifts 
\citep[e.g.,][]{2018MNRAS.474.1995R,2018MNRAS.481.3278R,2021MNRAS.508.2706Y,2022MNRAS.511..616T}. 
The classical way of regulating BH growth is by keeping the tight relation between $M_\bullet$ 
and the parent halo mass or the mass of the stellar bulge
\citep{2007ApJ...669...45H,2013ARA&A..51..511K},
then following the hierarchical DM halo growth
\citep[e.g.,][]{1998ApJ...503..505H,2010ApJ...718..231S,2021ApJ...910L..11K}.
The model parameters can thus be calibrated with low-$z$ BHMF and QLF,
and subsequently predict the higher redshift and faint quassar observations.
On the other hand, studies also conduct extrafpolation on the low-$z$ QLF evolution and forecast the high-$z$ QLF shapes,
which could be investigated by furture surveys
\citep[e.g.,][]{2020MNRAS.495.3252S,2022arXiv220702233F}.
}
...
\blue{
As a starting point to characterize the early assembly of massive BH populations,
the seed BH formation has been extensively investigated by numerical simulations and
...
\blue{
More explicitly, the initial mass function (IMF) of BH seeds is required to construct the picture of BH evolution.
}
