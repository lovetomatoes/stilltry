...
\begin{abstract}
The early evolution of the quasar luminosity and black hole mass function (MF) encodes key information
on the physics determining the radiative and accretion processes of supermassive black holes (SMBHs) in high-redshift quasars.
Although the shape of the luminosity function (LF) has been constrained by recent wide and deep surveys,
it still remains challenging to develop a theoretical model that explains the redshift evolution and BH growth self-consistently.
In this study, based on a semi-analytical model for the formation and growth of seed BHs
in quasar progenitor halos,
we construct the LF and MF of the early BH population that experiences multiple accretion bursts,
in each of which the Eddington ratio is assigned following a Schechter function.
Our best-fit model to reproduce the observed LF and MF at $z\simeq 6$
...
The predicted redshift evolution of both LF and MF of earliest BHs suggests a rapid decay of their number and mass
...
% the , Roman Space Telescope (RST), and Euclid.
\end{abstract}
...
The growth of massive black holes (BHs) in active galactic nuclei (AGN) is elegantly related to their luminous accretion phases
...
along with the quasar luminosity function \citep[e.g.,][]{2018ApJ...869..150M}.
...
with the \ion{Mg}{2} single-epoch method and bring insights of the mass distribution
...
that can be directly compared with the QLF and BHMF
...
fitting function forms \citep[e.g.,][]{2020MNRAS.495.3252S,2022arXiv220702233F}.
...
We assume that the early BH population experiences multiple accretion bursts, in each of which the Eddington ratio is assigned 
...
We also find that the observed Eddington-ratio distribution function is skewed to a log-normal shape from the intrinsic Shechter function
owing to detection limits of quasar observations.
Those results will be unveiled by future deep and wide surveys with the James Webb Space Telescope, Roman Space Telescope, and Euclid.
...
is propose by \citet{2014MNRAS.437.3550M} as
%
\begin{equation*}
...
With those values, the fraction of super-Eddington accreting BHs is estimated as $P(\lambda>1)=0.064$ and 0.075, respectively. 
While the probability of rapid accretion in each cycle is similar, multiple accretion episodes enlarge the difference.
Moreover, the best fit values of $\delta$ are $(0.001,0.055)$ for the two $\fseed$ cases,
the higher $\delta$ value encourages the growth of small BHs with $M_\bullet <10^8~\Msun$,
so that the ten-fold difference in $\fseed$ is nearly offset.
...
\begin{table*}
{ % group it, so that centering can work?
\centering
\renewcommand\thetable{2} %! fix indexing
\caption{Detection number of quasars estimated for future surveys}
% \tablenum{2}
\begin{tabular}{lcccccccccccc}
\hline Telescope & Survey area & Photo. depth & $N(z\sim 6)$ & $N(z\sim 7)$ & $N(z\sim 8)$ & $N(z\sim 9)$ & $N(z\sim10)$ \\
& (\rm{deg}$^2$) & (AB~mag) \\
\hline 
% 6758..6598057248175, 1514.3392258726712, 349.27228533671644, 85.15836783444871, 25.
Deep \it{LSST}   & 18000 & 27.5 & 73865 & 18470 &  4688 & 1237 & 389\\
Wide \it{RST}    &  2000 & 27   & 6758 &  1514 &  349 & 85 & 25  \\
Wide \it{Euclid} & 15000 & 24   & 6653  &  708 &   93 & 14 & 2  \\
\hline
\end{tabular}
\label{tab:N_detect}
}
...
In Fig.~\ref{fig:LFs}, we show the QLF prediction by the best-fit model with 1-$\sigma$ scatter at redshifts $z=$ 7 to 10.
Considering the scarcity of faint quasars ($\Muv\gtrsim -20$) sampled in \citet{2014ApJ...786..104U},
...
which is to be improved by the future equipments.
...
with both binned data points and the fitting functions in Schechter and double power law (DPL) shape
\citep{2021AJ....162...47B,2022ApJS..259...20H,2020MNRAS.493.2059B,2022arXiv220712356D,2013MNRAS.432.2696M,2019ApJ...883...99S,
2022ApJ...929....1H,2018ApJ...867..150M,2022arXiv220801612H,2016ApJ...819..129O,2022arXiv220709434N}.
Compared to our QLF predictions, galaxies prevail in the faint end at all these redshifts,
with their LFs quickly declines toward the luminous end.%, where quasars outshine.
The large number of galaxies with $\Muv\gtrsim -23$ makes it prohibitive to probe rare quasars among the faint objects detected.
While with increasing luminosity, the extrapolation of galaxy LF curve with the Schechter fitting function drops quickly,
crossing the QLF at $\Muv$ at critical values of $\Muv\sim-23$, $-24$, and $-25$ at redshifts $z=7-8$, $9$, and $10-13$, respectively.
While for the galaxy LF fitted by DPL function,
the corresponding crossing point shifts to $\Muv\sim-26$, $-25$, and $\ll -30$.
...
Deep {\it{LSST}} \citep{2017arXiv170801617R}, Wide {\it{RST}} \citep{2019arXiv190205569A}, and Wide {\it{Euclid}} \citep{2011arXiv1110.3193L}
...
In Fig.~\ref{fig:QLF_rhoz}, we present the number density of luminous quasars with $\Muv <-26$ as a function of redshift.
...
\begin{figure*}
\gridline{\fig{M0r8_f2linLF_spreadz7_KI.pdf}{0.45\textwidth}{}
          \fig{M0r8_f2linLF_spreadz8_KI.pdf}{0.45\textwidth}{}}
\gridline{\fig{M0r8_f2linLF_spreadz9_KI.pdf}{0.45\textwidth}{}
          \fig{M0r8_f2linLF_spreadz10_KI.pdf}{0.45\textwidth}{}}
\caption{QLF evolution at redshifts from $z=7$ to $z\gtrsim 10$.
In all panels the solid lines denote modeled QLF produced by the best-fit parameters and the shaded regions present the $1\sigma$ spread. 
The intrinsic QLF without obscuration effect is shown in the dashed lines,
deviating from the observed QLF mostly in the faint end.
The expected depths and volumes of future surveys with
Deep {\it{LSST}}, Wide {\it{RST}}, and Wide {\it{Euclid}} are overlaid with the blue thin lines,
indicating the detectability of quasars at these redshifts.
High-$z$ galaxy LF data points (grey) and fitting functions in the Schechter (dotted  magenta line) and DPL (dash-dotted  magenta line) shapes are shown.
With the extrapolated galaxy LFs in different shapes,
the galaxy contamination effect on quasar selection can be estimated.
\label{fig:LFs}}
\end{figure*}
...
The average duty cycle is found to be $\langle f_{\rm duty}\rangle \simeq 0.15$.
...
On the other hand, the average duty cycle for the entire BH population is given by $P(\lambda>1)= 0.075$ 
...
\section{Summary}
In this paper, we propose a theoretical model for the redshift-dependent QLF and BHMF at $z\gtrsim 6$,
applying the initial mass function of seed BHs.
We assume that the early BH population experiences multiple accretion bursts, in each of which the Eddington ratio
is assigned following a Schechter distribution function.
We conduct the MCMC fitting procedure used to optimize the BH growth parameters
so that the observed BHMF and QLF at $z\simeq 6$ are simultaneously reproduced.
Our best-fit model to reproduce the QLF and BHMF at $z\simeq 6$ yields the ERDF characterized with the two parameters of
$(\lambda_0, \alpha)=(0.89,0.12)$ and $(0.87,0.20)$ for the BH seeding fraction of $\fseed = 0.01$ and $0.1$, respectively.
The models suggests that several episodes of modest super-Eddington accretion occur and each accretion phase lasts $\simeq 20-30$ Myr.
...
toward higher redshifts as $\propto 10^{-k_i z}$, where $k_{\rm M}\simeq -0.68$ for the BH mass and $k_{\rm L}=$ for the quasar number.
...
\red{Add comparison to GLFs and expected detection numbers }\blue{
Comparing to galaxy LFs at redshifts from $z=7$ to $z\gtrsim 10$, the QLFs we predict is burried in the faint end at $\Muv \gtrsim -23$ by the huge galaxy population,
which raises the challenge of select quasars from the high-$z$ faint objects.
While in the luminous end, quasars account for a significant fraction of high-$z$ UV luminosity function,
we predict the critical luminosity at which galaxy and quasars make equal contribution,
depending on the fitting function form of galaxy LFs.}
We further explore individual BH evolutionary tracks starting from the BH seeds, applying the BH growth model
with the best-fit parameters reproducing their statistical properties.
For massive BHs that reach $\gtrsim 10^8~\Msun$ by $z\simeq 6$, the average duty cycle of accretion is as high as $\simeq 15~\%$.
...
Multiple accretion-burst treatment nicely produces the mass assembly history of individual high$-z$ luminous quasars,
unlike the case where one single value of the Eddington ratio is assigned.
We also find that the observed Eddington-ratio distribution function is skewed to a log-normal shape from the intrinsic Shechter function
owing to detection limits of quasar observations.
Those results will be unveiled by future deep and wide surveys with the JWST, LSST, RST, and Euclid.
