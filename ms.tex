...
obtained from the cosmological simulations in \citet{2022MNRAS.513..670N} (open square symbols).
...
\includegraphics[width=80mm]{M0r8_f2QLF.png}
\caption{
...
In Fig.~\ref{fig:QLF_rhoz}, we present the quasar number density as a function of redshift for 
the case of $\fseed =0.1$ (solid) and $0.01$ (dashed).
Each curve corresponds to the value at each UV magnitude from $\Muv=-27$ mag to $-23$ mag.
Our theoretical predictions are shown at $z\geq 6$ (thick curves), while observational results are compiled at lower redshifts (thin curves).
The evolutionary trend can be fitted as $\propto 10^{k_{\rm L}z}$,
\red{
where $k_{\rm L}\approx ***$ and $***$ for the brightest and faintest population
...
\blue{It clearly indicates that super-Eddington accretion episodes are required to the existence of the massive BHs}
...
\red{(to be revised) The two functions suggest a rapid decay of the number and mass density of massive BHs and luminous quasars in a cosmic volume
